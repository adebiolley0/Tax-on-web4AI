...
COLLECTION_NAME = os.environ.get("QDRANT_COLLECTION", "belgian_tax_docs")
VECTOR_SIZE = int(os.environ.get("QDRANT_VECTOR_SIZE", "384"))  # paraphrase-multilingual-MiniLM-L12-v2
