### Corpus B (40 questions: 24 train / 16 val)
...
| exp 13 lexical + bge-reranker-v2-m3 @20, β = 0.5 | 0.558 | **0.411** | 0.499 | 0.500 | 0.312 | 0.425 | 0.625 | 0.675 | 20.4 s |
| exp 13 lexical + bge-reranker-v2-m3 @20, β = 0.7 ← β chosen on train | 0.569 | **0.367** | 0.488 | 0.500 | 0.188 | 0.375 | 0.625 | 0.675 | 20.4 s |
| exp 13 lexical + bge-reranker-v2-m3 @20 | 0.567 | **0.443** | 0.517 | 0.500 | 0.312 | 0.425 | 0.625 | 0.675 | 20.4 s |
| exp 13 lexical + bge-reranker-v2-m3 @30, β = 0.5 | 0.566 | **0.411** | 0.504 | 0.500 | 0.312 | 0.425 | 0.625 | 0.700 | 30.6 s |
| exp 13 lexical + bge-reranker-v2-m3 @30, β = 0.7 ← β chosen on train **(train-selected depth, β)** | 0.570 | **0.367** | 0.489 | 0.500 | 0.188 | 0.375 | 0.625 | 0.725 | 30.6 s |
| exp 13 lexical + bge-reranker-v2-m3 @30 | 0.564 | **0.440** | 0.514 | 0.458 | 0.312 | 0.400 | 0.625 | 0.700 | 30.6 s |
| exp 13 lexical + bge-reranker-v2-m3 @50, β = 0.5 | 0.566 | **0.414** | 0.505 | 0.500 | 0.312 | 0.425 | 0.625 | 0.700 | 51.1 s |
| exp 13 lexical + bge-reranker-v2-m3 @50, β = 0.7 ← β chosen on train | 0.569 | **0.391** | 0.498 | 0.500 | 0.250 | 0.400 | 0.625 | 0.725 | 51.1 s |
| exp 13 lexical + bge-reranker-v2-m3 @50 | 0.559 | **0.424** | 0.505 | 0.458 | 0.312 | 0.400 | 0.625 | 0.700 | 51.1 s |
...
|---|---:|---|---:|---:|---:|---|
| lex13+bge@20_beta0.5 | -0.159 | 5 / 6 / 5 | 0.245 | 1.000 | 0.212 | [-0.411, +0.083] |
| lex13+bge@20_beta0.7 | -0.204 | 4 / 6 / 6 | 0.084 | 0.754 | 0.102 | [-0.418, -0.006] |
| lex13+bge@20 | -0.128 | 4 / 5 / 7 | 0.292 | 1.000 | 0.313 | [-0.354, +0.083] |
| lex13+bge@30_beta0.5 | -0.159 | 5 / 6 / 5 | 0.245 | 1.000 | 0.212 | [-0.411, +0.083] |
| lex13+bge@30_beta0.7 | -0.204 | 4 / 6 / 6 | 0.084 | 0.754 | 0.102 | [-0.418, -0.006] |
| lex13+bge@30 | -0.131 | 4 / 5 / 7 | 0.280 | 1.000 | 0.313 | [-0.355, +0.078] |
| lex13+bge@50_beta0.5 | -0.157 | 5 / 6 / 5 | 0.252 | 1.000 | 0.212 | [-0.411, +0.087] |
| lex13+bge@50_beta0.7 | -0.180 | 4 / 5 / 7 | 0.123 | 1.000 | 0.172 | [-0.396, +0.016] |
| lex13+bge@50 | -0.146 | 3 / 5 / 8 | 0.230 | 0.727 | 0.233 | [-0.371, +0.063] |
...
|---|---:|---|---:|---:|---:|
| lex13+bge@20 | -0.007 | 4 / 5 / 7 | 0.922 | 1.000 | 0.858 |
| lex13+bge@30 | -0.011 | 4 / 5 / 7 | 0.890 | 1.000 | 0.766 |
| lex13+bge@50 | -0.026 | 4 / 6 / 6 | 0.743 | 0.754 | 0.646 |

Per-question ranks on val (old first stage / exp-13 lexical / bar / lex13+bge @20 / @30 / @50):

| qid | question | old 1st | lex13 | bar | @20 | @30 | @50 |
|---|---|---:|---:|---:|---:|---:|---:|
| B1 | Quels sont les taux de l'impôt des personnes physiques par tranche de revenus po | 2 | 5 | 1 | 3 | 3 | 4 |
| B6 | Quelle participation minimale une société doit-elle détenir pour bénéficier de l | 7 | 6 | 8 | 4 | 5 | 5 |
...
| B21 | Je mets un appartement en location à un particulier qui y habite : sur quelle ba | 1 | 3 | 3 | 2 | 2 | 3 |
