...
from tax_search.models import Document, EmbeddedChunk, SourceType
from tax_search.qdrant_store import COLLECTION_NAME, ensure_collection, get_client, upsert_chunks
...
def _parse_fisconet_doc(raw: dict) -> Document:
    ...
    from tax_ingestion.fisconet.client import _html_to_text, _parse_date, _parse_datetime
